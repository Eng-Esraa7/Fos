...
void _main(void)
{
  ...
  800041:	e8 7c 20 00 00       	call   8020c2 <sys_disable_interrupt>
		cprintf("\n");
  ...
  800069:	68 7b 27 80 00       	push   $0x80277b
  ...
  80009f:	50                   	push   %eax
  8000a0:	68 94 27 80 00       	push   $0x802794
  ...
  80011e:	68 03 28 80 00       	push   $0x802803
  ...
  800162:	e8 75 1f 00 00       	call   8020dc <sys_enable_interrupt>
  ...
  8001d2:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001d5:	e8 e8 1e 00 00       	call   8020c2 <sys_disable_interrupt>
			cprintf("Sorting is Finished!!!!it'll be checked now....\n") ;
  8001da:	83 ec 0c             	sub    $0xc,%esp
  8001dd:	68 0c 28 80 00       	push   $0x80280c
  8001e2:	e8 55 08 00 00       	call   800a3c <cprintf>
  8001e7:	83 c4 10             	add    $0x10,%esp
		//		PrintElements(Elements, NumOfElements);
		sys_enable_interrupt();
  8001ea:	e8 ed 1e 00 00       	call   8020dc <sys_enable_interrupt>
  ...
  80020c:	68 40 28 80 00       	push   $0x802840
  800211:	6a 48                	push   $0x48
  800213:	68 62 28 80 00       	push   $0x802862
  800218:	e8 7d 05 00 00       	call   80079a <_panic>
		else
		{
			sys_disable_interrupt();
  80021d:	e8 a0 1e 00 00       	call   8020c2 <sys_disable_interrupt>
			cprintf("\n===============================================\n") ;
  800222:	83 ec 0c             	sub    $0xc,%esp
  800225:	68 78 28 80 00       	push   $0x802878
  80022a:	e8 0d 08 00 00       	call   800a3c <cprintf>
  80022f:	83 c4 10             	add    $0x10,%esp
			cprintf("Congratulations!! The array is sorted correctly\n") ;
  800232:	83 ec 0c             	sub    $0xc,%esp
  800235:	68 ac 28 80 00       	push   $0x8028ac
  80023a:	e8 fd 07 00 00       	call   800a3c <cprintf>
  80023f:	83 c4 10             	add    $0x10,%esp
			cprintf("===============================================\n\n") ;
  800242:	83 ec 0c             	sub    $0xc,%esp
  800245:	68 e0 28 80 00       	push   $0x8028e0
  80024a:	e8 ed 07 00 00       	call   800a3c <cprintf>
  80024f:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  800252:	e8 85 1e 00 00       	call   8020dc <sys_enable_interrupt>
		}

		sys_disable_interrupt();
  800257:	e8 66 1e 00 00       	call   8020c2 <sys_disable_interrupt>
			Chose = 0 ;
  ...
  800265:	68 12 29 80 00       	push   $0x802912
  ...
  8002ae:	75 b2                	jne    800262 <_main+0x22a>
		...
		sys_enable_interrupt();
  8002b0:	e8 27 1e 00 00       	call   8020dc <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800555:	68 60 27 80 00       	push   $0x802760
  ...
  800576:	50                   	push   %eax
  800577:	68 30 29 80 00       	push   $0x802930
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8005a4:	50                   	push   %eax
  8005a5:	68 35 29 80 00       	push   $0x802935
...
cputchar(int ch)
{
  ...
  8005c8:	50                   	push   %eax
  8005c9:	e8 28 1b 00 00       	call   8020f6 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  8005d7:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005da:	e8 e3 1a 00 00       	call   8020c2 <sys_disable_interrupt>
	char c = ch;
  ...
  8005ec:	50                   	push   %eax
  8005ed:	e8 04 1b 00 00       	call   8020f6 <sys_cputc>
  8005f2:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8005f5:	e8 e2 1a 00 00       	call   8020dc <sys_enable_interrupt>
}
  8005fa:	90                   	nop
  8005fb:	c9                   	leave  
  8005fc:	c3                   	ret    
...
getchar(void)
{
  ...
  80060a:	eb 08                	jmp    800614 <getchar+0x17>
	{
		c = sys_cgetc();
  80060c:	e8 c9 18 00 00       	call   801eda <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800622:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800625:	e8 98 1a 00 00       	call   8020c2 <sys_disable_interrupt>
	int c=0;
  ...
  800631:	eb 08                	jmp    80063b <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800633:	e8 a2 18 00 00       	call   801eda <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  80063f:	74 f2                	je     800633 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  800641:	e8 96 1a 00 00       	call   8020dc <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  80065b:	e8 c7 18 00 00       	call   801f27 <sys_getenvindex>
  ...
  8006d5:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  8006d8:	e8 e5 19 00 00       	call   8020c2 <sys_disable_interrupt>
	cprintf("**************************************\n");
  8006dd:	83 ec 0c             	sub    $0xc,%esp
  8006e0:	68 54 29 80 00       	push   $0x802954
  ...
  800706:	52                   	push   %edx
  800707:	50                   	push   %eax
  800708:	68 7c 29 80 00       	push   $0x80297c
  ...
  80072e:	52                   	push   %edx
  80072f:	50                   	push   %eax
  800730:	68 a4 29 80 00       	push   $0x8029a4
  ...
  80074b:	50                   	push   %eax
  80074c:	68 e5 29 80 00       	push   $0x8029e5
  800751:	e8 e6 02 00 00       	call   800a3c <cprintf>
  800756:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800759:	83 ec 0c             	sub    $0xc,%esp
  80075c:	68 54 29 80 00       	push   $0x802954
  800761:	e8 d6 02 00 00       	call   800a3c <cprintf>
  800766:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800769:	e8 6e 19 00 00       	call   8020dc <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800781:	e8 6d 17 00 00       	call   801ef3 <sys_env_destroy>
...
exit(void)
{
  ...
  80078f:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800792:	e8 c2 17 00 00       	call   801f59 <sys_env_exit>
}
  800797:	90                   	nop
  800798:	c9                   	leave  
  800799:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8007ba:	50                   	push   %eax
  8007bb:	68 fc 29 80 00       	push   $0x8029fc
  ...
  8007d3:	50                   	push   %eax
  8007d4:	68 01 2a 80 00       	push   $0x802a01
  ...
  8007f8:	68 1d 2a 80 00       	push   $0x802a1d
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800824:	68 20 2a 80 00       	push   $0x802a20
  800829:	6a 26                	push   $0x26
  80082b:	68 6c 2a 80 00       	push   $0x802a6c
  ...
  8008ea:	68 78 2a 80 00       	push   $0x802a78
  8008ef:	6a 3a                	push   $0x3a
  8008f1:	68 6c 2a 80 00       	push   $0x802a6c
  ...
  800954:	68 cc 2a 80 00       	push   $0x802acc
  800959:	6a 44                	push   $0x44
  80095b:	68 6c 2a 80 00       	push   $0x802a6c
...
static void putch(int ch, struct printbuf *b) {
  ...
  8009ac:	51                   	push   %ecx
  8009ad:	52                   	push   %edx
  8009ae:	e8 fe 14 00 00       	call   801eb1 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800a24:	50                   	push   %eax
  800a25:	e8 87 14 00 00       	call   801eb1 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800a6c:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800a6f:	e8 4e 16 00 00       	call   8020c2 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800a8c:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800a8f:	e8 48 16 00 00       	call   8020dc <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800ad9:	e8 06 1a 00 00       	call   8024e4 <__udivdi3>
  ...
  800b27:	52                   	push   %edx
  800b28:	50                   	push   %eax
  800b29:	e8 c6 1a 00 00       	call   8025f4 <__umoddi3>
  800b2e:	83 c4 10             	add    $0x10,%esp
  800b31:	05 34 2d 80 00       	add    $0x802d34,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800c84:	8b 04 85 58 2d 80 00 	mov    0x802d58(,%eax,4),%eax
  ...
  800d65:	8b 34 9d a0 2b 80 00 	mov    0x802ba0(,%ebx,4),%esi
  800d6c:	85 f6                	test   %esi,%esi
  800d6e:	75 19                	jne    800d89 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800d70:	53                   	push   %ebx
  800d71:	68 45 2d 80 00       	push   $0x802d45
  ...
  800d84:	e9 49 02 00 00       	jmp    800fd2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800d89:	56                   	push   %esi
  800d8a:	68 4e 2d 80 00       	push   $0x802d4e
  ...
  800db5:	75 05                	jne    800dbc <vprintfmt+0x1a6>
				p = "(null)";
  800db7:	be 51 2d 80 00       	mov    $0x802d51,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  8010d0:	68 b0 2e 80 00       	push   $0x802eb0
  ...
  801112:	68 b3 2e 80 00       	push   $0x802eb3
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  8011bf:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8011c2:	e8 fb 0e 00 00       	call   8020c2 <sys_disable_interrupt>
	int i, c, echoing;
  ...
  8011d3:	68 b0 2e 80 00       	push   $0x802eb0
  ...
  801211:	68 b3 2e 80 00       	push   $0x802eb3
  801216:	e8 21 f8 ff ff       	call   800a3c <cprintf>
  80121b:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  80121e:	e8 b9 0e 00 00       	call   8020dc <sys_enable_interrupt>
			return;
  ...
  8012b3:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  8012b6:	e8 21 0e 00 00       	call   8020dc <sys_enable_interrupt>
			return;
...
void* malloc(uint32 size)
{
  ...
  8019cf:	83 ec 18             	sub    $0x18,%esp
	...
	free_mem_count=0;
  8019d2:	c7 05 4c 31 80 00 00 	movl   $0x0,0x80314c
  8019d9:	00 00 00 
	//BOOL VARIABLE check is there suitable space or not
	find=0;
  8019dc:	c7 05 48 31 80 00 00 	movl   $0x0,0x803148
  8019e3:	00 00 00 
	// Initialize user heap memory (1GB = 2^30)->MAX_NUM
	if(intialize_mem==0)
  8019e6:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8019eb:	85 c0                	test   %eax,%eax
  8019ed:	75 65                	jne    801a54 <malloc+0x88>
	{
		for(j=USER_HEAP_START;j<USER_HEAP_MAX;j+=PAGE_SIZE)
  8019ef:	c7 05 2c 31 80 00 00 	movl   $0x80000000,0x80312c
  8019f6:	00 00 80 
  8019f9:	eb 43                	jmp    801a3e <malloc+0x72>
		{
			pages[array_size].address=j; // store start address of each 4k(Page_size)
  8019fb:	8b 15 30 30 80 00    	mov    0x803030,%edx
  801a01:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801a06:	c1 e2 04             	shl    $0x4,%edx
  801a09:	81 c2 60 31 80 00    	add    $0x803160,%edx
  ...
  801a19:	05 64 31 80 00       	add    $0x803164,%eax
  801a1e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			array_size+=1;
  801a24:	a1 30 30 80 00       	mov    0x803030,%eax
  801a29:	40                   	inc    %eax
  801a2a:	a3 30 30 80 00       	mov    %eax,0x803030
	//BOOL VARIABLE check is there suitable space or not
	find=0;
	// Initialize user heap memory (1GB = 2^30)->MAX_NUM
	if(intialize_mem==0)
	{
		for(j=USER_HEAP_START;j<USER_HEAP_MAX;j+=PAGE_SIZE)
  801a2f:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801a34:	05 00 10 00 00       	add    $0x1000,%eax
  801a39:	a3 2c 31 80 00       	mov    %eax,0x80312c
  801a3e:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801a43:	3d ff ff ff 9f       	cmp    $0x9fffffff,%eax
  801a48:	76 b1                	jbe    8019fb <malloc+0x2f>
		{
			pages[array_size].address=j; // store start address of each 4k(Page_size)
			pages[array_size].used=0;//not used
			array_size+=1;
		...
		intialize_mem=1;
  801a4a:	c7 05 2c 30 80 00 01 	movl   $0x1,0x80302c
  801a51:	00 00 00 
	}
	be_space=MAX_NUM;
  801a54:	c7 05 5c 31 80 00 00 	movl   $0x40000000,0x80315c
  801a5b:	00 00 40 
  ...
  801a7e:	f7 75 f4             	divl   -0xc(%ebp)
  801a81:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a84:	29 d0                	sub    %edx,%eax
  801a86:	a3 28 31 80 00       	mov    %eax,0x803128
	no_of_pages=round/4;
  801a8b:	a1 28 31 80 00       	mov    0x803128,%eax
  801a90:	c1 e8 02             	shr    $0x2,%eax
  801a93:	a3 60 31 a0 00       	mov    %eax,0xa03160
	// find empty spaces in user heap mem
	for(j=0;j<array_size;++j)
  801a98:	c7 05 2c 31 80 00 00 	movl   $0x0,0x80312c
  801a9f:	00 00 00 
  801aa2:	e9 96 00 00 00       	jmp    801b3d <malloc+0x171>
	{
		if(pages[j].used==0) //check empty pages
  801aa7:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801aac:	c1 e0 04             	shl    $0x4,%eax
  801aaf:	05 64 31 80 00       	add    $0x803164,%eax
  801ab4:	8b 00                	mov    (%eax),%eax
  801ab6:	85 c0                	test   %eax,%eax
  801ab8:	75 2a                	jne    801ae4 <malloc+0x118>
		{
			//first empty space only
			if(free_mem_count==0)
  801aba:	a1 4c 31 80 00       	mov    0x80314c,%eax
  801abf:	85 c0                	test   %eax,%eax
  801ac1:	75 14                	jne    801ad7 <malloc+0x10b>
			{
				first_empty_space=pages[j].address;
  801ac3:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801ac8:	c1 e0 04             	shl    $0x4,%eax
  801acb:	05 60 31 80 00       	add    $0x803160,%eax
  801ad0:	8b 00                	mov    (%eax),%eax
  801ad2:	a3 30 31 80 00       	mov    %eax,0x803130
			}
			free_mem_count++; // increment num of free spaces
  801ad7:	a1 4c 31 80 00       	mov    0x80314c,%eax
  801adc:	40                   	inc    %eax
  801add:	a3 4c 31 80 00       	mov    %eax,0x80314c
  801ae2:	eb 4e                	jmp    801b32 <malloc+0x166>
		}
		else //pages[j].used!=0(==1)used
		{
			// best fit strategy
			emp_space=free_mem_count*PAGE_SIZE;
  801ae4:	a1 4c 31 80 00       	mov    0x80314c,%eax
  801ae9:	c1 e0 0c             	shl    $0xc,%eax
  801aec:	a3 34 31 80 00       	mov    %eax,0x803134
			// find min space to fit given size in array
			if(be_space>emp_space&&emp_space>=size)
  801af1:	8b 15 5c 31 80 00    	mov    0x80315c,%edx
  801af7:	a1 34 31 80 00       	mov    0x803134,%eax
  801afc:	39 c2                	cmp    %eax,%edx
  801afe:	76 28                	jbe    801b28 <malloc+0x15c>
  801b00:	a1 34 31 80 00       	mov    0x803134,%eax
  801b05:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b08:	72 1e                	jb     801b28 <malloc+0x15c>
			{
				// reset min value to repeat condition to find suitable space (ms7 mosawi2 aw2kbr b shwi2)
				be_space=emp_space;
  801b0a:	a1 34 31 80 00       	mov    0x803134,%eax
  801b0f:	a3 5c 31 80 00       	mov    %eax,0x80315c
				// set start address of empty space
				be_address=first_empty_space;
  801b14:	a1 30 31 80 00       	mov    0x803130,%eax
  801b19:	a3 58 31 80 00       	mov    %eax,0x803158
				find=1;
  801b1e:	c7 05 48 31 80 00 01 	movl   $0x1,0x803148
  801b25:	00 00 00 
			}
			free_mem_count=0;
  801b28:	c7 05 4c 31 80 00 00 	movl   $0x0,0x80314c
  801b2f:	00 00 00 
	be_space=MAX_NUM;
	//find upper limit of size and calculate num of pages with given size
	round=ROUNDUP(size/1024,4);
	...
	// find empty spaces in user heap mem
	for(j=0;j<array_size;++j)
  801b32:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801b37:	40                   	inc    %eax
  801b38:	a3 2c 31 80 00       	mov    %eax,0x80312c
  801b3d:	8b 15 2c 31 80 00    	mov    0x80312c,%edx
  801b43:	a1 30 30 80 00       	mov    0x803030,%eax
  801b48:	39 c2                	cmp    %eax,%edx
  801b4a:	0f 82 57 ff ff ff    	jb     801aa7 <malloc+0xdb>
			}
			free_mem_count=0;
		}
	}
	...
	emp_space=free_mem_count*PAGE_SIZE;
  801b50:	a1 4c 31 80 00       	mov    0x80314c,%eax
  801b55:	c1 e0 0c             	shl    $0xc,%eax
  801b58:	a3 34 31 80 00       	mov    %eax,0x803134
	// check if this empty space suitable to fit given size or not
	if(be_space>emp_space&&emp_space>=size)
  801b5d:	8b 15 5c 31 80 00    	mov    0x80315c,%edx
  801b63:	a1 34 31 80 00       	mov    0x803134,%eax
  801b68:	39 c2                	cmp    %eax,%edx
  801b6a:	76 1e                	jbe    801b8a <malloc+0x1be>
  801b6c:	a1 34 31 80 00       	mov    0x803134,%eax
  801b71:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b74:	72 14                	jb     801b8a <malloc+0x1be>
	{
		find=1;
  801b76:	c7 05 48 31 80 00 01 	movl   $0x1,0x803148
  801b7d:	00 00 00 
		// set final start address of empty space
		be_address=first_empty_space;
  801b80:	a1 30 31 80 00       	mov    0x803130,%eax
  801b85:	a3 58 31 80 00       	mov    %eax,0x803158
	}
	if(find==0) // no suitable space found
  801b8a:	a1 48 31 80 00       	mov    0x803148,%eax
  801b8f:	85 c0                	test   %eax,%eax
  801b91:	75 0a                	jne    801b9d <malloc+0x1d1>
	{
		return NULL;
  801b93:	b8 00 00 00 00       	mov    $0x0,%eax
  801b98:	e9 fa 00 00 00       	jmp    801c97 <malloc+0x2cb>
	}
	for(j=0;j<array_size;++j)
  801b9d:	c7 05 2c 31 80 00 00 	movl   $0x0,0x80312c
  801ba4:	00 00 00 
  801ba7:	eb 2f                	jmp    801bd8 <malloc+0x20c>
	{
		if (pages[j].address==be_address)
  801ba9:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801bae:	c1 e0 04             	shl    $0x4,%eax
  801bb1:	05 60 31 80 00       	add    $0x803160,%eax
  801bb6:	8b 10                	mov    (%eax),%edx
  801bb8:	a1 58 31 80 00       	mov    0x803158,%eax
  801bbd:	39 c2                	cmp    %eax,%edx
  801bbf:	75 0c                	jne    801bcd <malloc+0x201>
		{
			index=j;
  801bc1:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801bc6:	a3 50 31 80 00       	mov    %eax,0x803150
			break;
  801bcb:	eb 1a                	jmp    801be7 <malloc+0x21b>
	}
	if(find==0) // no suitable space found
	{
		return NULL;
	...
	for(j=0;j<array_size;++j)
  801bcd:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801bd2:	40                   	inc    %eax
  801bd3:	a3 2c 31 80 00       	mov    %eax,0x80312c
  801bd8:	8b 15 2c 31 80 00    	mov    0x80312c,%edx
  801bde:	a1 30 30 80 00       	mov    0x803030,%eax
  801be3:	39 c2                	cmp    %eax,%edx
  801be5:	72 c2                	jb     801ba9 <malloc+0x1dd>
			index=j;
			break;
		}
	}
  ...
  801be7:	8b 15 50 31 80 00    	mov    0x803150,%edx
  801bed:	a1 60 31 a0 00       	mov    0xa03160,%eax
  801bf2:	c1 e2 04             	shl    $0x4,%edx
  801bf5:	81 c2 68 31 80 00    	add    $0x803168,%edx
  801bfb:	89 02                	mov    %eax,(%edx)
	pages[index].siize=size;
  801bfd:	a1 50 31 80 00       	mov    0x803150,%eax
  801c02:	c1 e0 04             	shl    $0x4,%eax
  801c05:	8d 90 6c 31 80 00    	lea    0x80316c(%eax),%edx
  801c0b:	8b 45 08             	mov    0x8(%ebp),%eax
  801c0e:	89 02                	mov    %eax,(%edx)
	ind=index;
  801c10:	a1 50 31 80 00       	mov    0x803150,%eax
  801c15:	a3 3c 31 80 00       	mov    %eax,0x80313c

	// loop in n to reset used value to 1 b3add l pages
	for(j=0;j<no_of_pages;++j)
  801c1a:	c7 05 2c 31 80 00 00 	movl   $0x0,0x80312c
  801c21:	00 00 00 
  801c24:	eb 29                	jmp    801c4f <malloc+0x283>
	{
		pages[index].used=1;
  801c26:	a1 50 31 80 00       	mov    0x803150,%eax
  801c2b:	c1 e0 04             	shl    $0x4,%eax
  801c2e:	05 64 31 80 00       	add    $0x803164,%eax
  801c33:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
		++index;
  801c39:	a1 50 31 80 00       	mov    0x803150,%eax
  801c3e:	40                   	inc    %eax
  801c3f:	a3 50 31 80 00       	mov    %eax,0x803150
	pages[index].num_of_pages=no_of_pages;
	pages[index].siize=size;
	ind=index;
  ...
  801c55:	a1 60 31 a0 00       	mov    0xa03160,%eax
  801c5a:	39 c2                	cmp    %eax,%edx
  801c5c:	72 c8                	jb     801c26 <malloc+0x25a>
	{
		pages[index].used=1;
		++index;
	}
  ...
  801c5e:	a1 58 31 80 00       	mov    0x803158,%eax
  801c63:	83 ec 08             	sub    $0x8,%esp
  801c66:	ff 75 08             	pushl  0x8(%ebp)
  801c69:	50                   	push   %eax
  801c6a:	e8 ea 03 00 00       	call   802059 <sys_allocateMem>
  801c6f:	83 c4 10             	add    $0x10,%esp
	ad = be_address;
  801c72:	a1 58 31 80 00       	mov    0x803158,%eax
  801c77:	a3 20 31 80 00       	mov    %eax,0x803120
	si = size/2;
  801c7c:	8b 45 08             	mov    0x8(%ebp),%eax
  801c7f:	d1 e8                	shr    %eax
  801c81:	a3 38 31 80 00       	mov    %eax,0x803138
	nump = no_of_pages/2;
  801c86:	a1 60 31 a0 00       	mov    0xa03160,%eax
  801c8b:	d1 e8                	shr    %eax
  801c8d:	a3 40 31 80 00       	mov    %eax,0x803140
	return (void*)be_address;
  801c92:	a1 58 31 80 00       	mov    0x803158,%eax
...
int index;
	//found index of virtual address
	for(int i=0;i<array_size;i++)
  801cc2:	ff 45 f0             	incl   -0x10(%ebp)
  801cc5:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801cc8:	a1 30 30 80 00       	mov    0x803030,%eax
  801ccd:	39 c2                	cmp    %eax,%edx
  801ccf:	72 d7                	jb     801ca8 <free+0xf>
			break;
		}
	}
  ...
  801cd7:	05 68 31 80 00       	add    $0x803168,%eax
  801cdc:	8b 00                	mov    (%eax),%eax
  801cde:	89 45 e8             	mov    %eax,-0x18(%ebp)
	pages[index].num_of_pages=0;
  801ce1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ce4:	c1 e0 04             	shl    $0x4,%eax
  801ce7:	05 68 31 80 00       	add    $0x803168,%eax
  ...
  801cf8:	05 60 31 80 00       	add    $0x803160,%eax
  ...
  801d09:	eb 17                	jmp    801d22 <free+0x89>
	{
		pages[index].used=0;
  801d0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d0e:	c1 e0 04             	shl    $0x4,%eax
  801d11:	05 64 31 80 00       	add    $0x803164,%eax
  ...
  801d1c:	ff 45 f4             	incl   -0xc(%ebp)
	...
	//set used to 0
	for(int i=0;i<num_of_pages;i++)
  801d1f:	ff 45 ec             	incl   -0x14(%ebp)
  801d22:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801d25:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801d28:	7c e1                	jl     801d0b <free+0x72>
	{
		pages[index].used=0;
		index++;
	}
  ...
  801d2a:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801d2d:	c1 e0 0c             	shl    $0xc,%eax
  801d30:	83 ec 08             	sub    $0x8,%esp
  801d33:	50                   	push   %eax
  801d34:	ff 75 e4             	pushl  -0x1c(%ebp)
  801d37:	e8 01 03 00 00       	call   80203d <sys_freeMem>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801d4b:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801d4e:	83 ec 04             	sub    $0x4,%esp
  801d51:	68 c4 2e 80 00       	push   $0x802ec4
  801d56:	68 a0 00 00 00       	push   $0xa0
  801d5b:	68 e7 2e 80 00       	push   $0x802ee7
  801d60:	e8 35 ea ff ff       	call   80079a <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801d6e:	68 c4 2e 80 00       	push   $0x802ec4
  801d73:	68 a6 00 00 00       	push   $0xa6
  801d78:	68 e7 2e 80 00       	push   $0x802ee7
  801d7d:	e8 18 ea ff ff       	call   80079a <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801d8b:	68 c4 2e 80 00       	push   $0x802ec4
  801d90:	68 ac 00 00 00       	push   $0xac
  801d95:	68 e7 2e 80 00       	push   $0x802ee7
  801d9a:	e8 fb e9 ff ff       	call   80079a <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801da8:	68 c4 2e 80 00       	push   $0x802ec4
  801dad:	68 b1 00 00 00       	push   $0xb1
  801db2:	68 e7 2e 80 00       	push   $0x802ee7
  801db7:	e8 de e9 ff ff       	call   80079a <_panic>
...
void expand(uint32 newSize)
{
  ...
  801dc5:	68 c4 2e 80 00       	push   $0x802ec4
  801dca:	68 b7 00 00 00       	push   $0xb7
  801dcf:	68 e7 2e 80 00       	push   $0x802ee7
  801dd4:	e8 c1 e9 ff ff       	call   80079a <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801de2:	68 c4 2e 80 00       	push   $0x802ec4
  801de7:	68 bb 00 00 00       	push   $0xbb
  801dec:	68 e7 2e 80 00       	push   $0x802ee7
  801df1:	e8 a4 e9 ff ff       	call   80079a <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801dff:	68 c4 2e 80 00       	push   $0x802ec4
  801e04:	68 c0 00 00 00       	push   $0xc0
  801e09:	68 e7 2e 80 00       	push   $0x802ee7
  801e0e:	e8 87 e9 ff ff       	call   80079a <_panic>
...
void halfLast(){
  ...
  801e19:	a1 20 31 80 00       	mov    0x803120,%eax
  801e1e:	8b 15 38 31 80 00    	mov    0x803138,%edx
  801e24:	01 d0                	add    %edx,%eax
  801e26:	89 45 f0             	mov    %eax,-0x10(%ebp)
	ind+=nump;
  801e29:	8b 15 3c 31 80 00    	mov    0x80313c,%edx
  801e2f:	a1 40 31 80 00       	mov    0x803140,%eax
  801e34:	01 d0                	add    %edx,%eax
  801e36:	a3 3c 31 80 00       	mov    %eax,0x80313c
	for(int i=0;i<nump;i++){
  801e3b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801e42:	eb 21                	jmp    801e65 <halfLast+0x52>
		pages[ind].used=0;
  801e44:	a1 3c 31 80 00       	mov    0x80313c,%eax
  801e49:	c1 e0 04             	shl    $0x4,%eax
  801e4c:	05 64 31 80 00       	add    $0x803164,%eax
  801e51:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		ind++;
  801e57:	a1 3c 31 80 00       	mov    0x80313c,%eax
  801e5c:	40                   	inc    %eax
  801e5d:	a3 3c 31 80 00       	mov    %eax,0x80313c
		pages[va].used=0;
		va+=PAGE_SIZE;
	}*/
	uint32 halfAdd = ad+si;
	ind+=nump;
	for(int i=0;i<nump;i++){
  801e62:	ff 45 f4             	incl   -0xc(%ebp)
  801e65:	a1 40 31 80 00       	mov    0x803140,%eax
  801e6a:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801e6d:	7c d5                	jl     801e44 <halfLast+0x31>
		pages[ind].used=0;
		ind++;
	}
	sys_freeMem(halfAdd,si);
  801e6f:	a1 38 31 80 00       	mov    0x803138,%eax
  801e74:	83 ec 08             	sub    $0x8,%esp
  801e77:	50                   	push   %eax
  801e78:	ff 75 f0             	pushl  -0x10(%ebp)
  801e7b:	e8 bd 01 00 00       	call   80203d <sys_freeMem>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801e9b:	8b 7d 18             	mov    0x18(%ebp),%edi
  801e9e:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801ebd:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801ecf:	e8 b2 ff ff ff       	call   801e86 <syscall>
...
sys_cgetc(void)
{
  ...
  801ee9:	e8 98 ff ff ff       	call   801e86 <syscall>
  801eee:	83 c4 18             	add    $0x18,%esp
}
  801ef1:	c9                   	leave  
  801ef2:	c3                   	ret    

00801ef3 <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  801f01:	50                   	push   %eax
  801f02:	6a 05                	push   $0x5
  801f04:	e8 7d ff ff ff       	call   801e86 <syscall>
  801f09:	83 c4 18             	add    $0x18,%esp
}
  801f0c:	c9                   	leave  
  801f0d:	c3                   	ret    

00801f0e <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801f1d:	e8 64 ff ff ff       	call   801e86 <syscall>
  801f22:	83 c4 18             	add    $0x18,%esp
}
  801f25:	c9                   	leave  
  801f26:	c3                   	ret    

00801f27 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801f34:	6a 03                	push   $0x3
  801f36:	e8 4b ff ff ff       	call   801e86 <syscall>
  801f3b:	83 c4 18             	add    $0x18,%esp
}
  801f3e:	c9                   	leave  
  801f3f:	c3                   	ret    

00801f40 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801f4d:	6a 04                	push   $0x4
  801f4f:	e8 32 ff ff ff       	call   801e86 <syscall>
  801f54:	83 c4 18             	add    $0x18,%esp
}
  801f57:	c9                   	leave  
  801f58:	c3                   	ret    

00801f59 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801f66:	6a 06                	push   $0x6
  801f68:	e8 19 ff ff ff       	call   801e86 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801f82:	52                   	push   %edx
  801f83:	50                   	push   %eax
  801f84:	6a 07                	push   $0x7
  801f86:	e8 fb fe ff ff       	call   801e86 <syscall>
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801fa7:	52                   	push   %edx
  801fa8:	50                   	push   %eax
  801fa9:	6a 08                	push   $0x8
  801fab:	e8 d6 fe ff ff       	call   801e86 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801fc9:	52                   	push   %edx
  801fca:	50                   	push   %eax
  801fcb:	6a 09                	push   $0x9
  801fcd:	e8 b4 fe ff ff       	call   801e86 <syscall>
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801fe6:	6a 0a                	push   $0xa
  801fe8:	e8 99 fe ff ff       	call   801e86 <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  801fff:	6a 0b                	push   $0xb
  802001:	e8 80 fe ff ff       	call   801e86 <syscall>
...
uint32 sys_calculate_modified_frames()
{
  ...
  802018:	6a 0c                	push   $0xc
  80201a:	e8 67 fe ff ff       	call   801e86 <syscall>
...
uint32 sys_calculate_notmod_frames()
{
  ...
  802031:	6a 0d                	push   $0xd
  802033:	e8 4e fe ff ff       	call   801e86 <syscall>
  802038:	83 c4 18             	add    $0x18,%esp
}
  80203b:	c9                   	leave  
  80203c:	c3                   	ret    

0080203d <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  80204c:	6a 11                	push   $0x11
  80204e:	e8 33 fe ff ff       	call   801e86 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  802068:	6a 12                	push   $0x12
  80206a:	e8 17 fe ff ff       	call   801e86 <syscall>
...
00802075 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  802084:	e8 fd fd ff ff       	call   801e86 <syscall>
  802089:	83 c4 18             	add    $0x18,%esp
}
  80208c:	c9                   	leave  
  80208d:	c3                   	ret    

0080208e <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  80209c:	6a 0f                	push   $0xf
  80209e:	e8 e3 fd ff ff       	call   801e86 <syscall>
  8020a3:	83 c4 18             	add    $0x18,%esp
}
  8020a6:	c9                   	leave  
  8020a7:	c3                   	ret    

008020a8 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  8020b5:	6a 10                	push   $0x10
  8020b7:	e8 ca fd ff ff       	call   801e86 <syscall>
...
008020c2 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  8020cf:	6a 14                	push   $0x14
  8020d1:	e8 b0 fd ff ff       	call   801e86 <syscall>
...
sys_enable_interrupt()
{
  ...
  8020e9:	6a 15                	push   $0x15
  8020eb:	e8 96 fd ff ff       	call   801e86 <syscall>
...
sys_cputc(const char c)
{
  ...
  80210e:	50                   	push   %eax
  80210f:	6a 16                	push   $0x16
  802111:	e8 70 fd ff ff       	call   801e86 <syscall>
...
sys_clear_ffl()
{
  ...
  80212b:	e8 56 fd ff ff       	call   801e86 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  802148:	e8 39 fd ff ff       	call   801e86 <syscall>
  80214d:	83 c4 18             	add    $0x18,%esp
}
  802150:	c9                   	leave  
  802151:	c3                   	ret    

00802152 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802161:	52                   	push   %edx
  802162:	50                   	push   %eax
  802163:	6a 1b                	push   $0x1b
  802165:	e8 1c fd ff ff       	call   801e86 <syscall>
  80216a:	83 c4 18             	add    $0x18,%esp
}
  80216d:	c9                   	leave  
  80216e:	c3                   	ret    

0080216f <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80217e:	52                   	push   %edx
  80217f:	50                   	push   %eax
  802180:	6a 19                	push   $0x19
  802182:	e8 ff fc ff ff       	call   801e86 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80219c:	52                   	push   %edx
  80219d:	50                   	push   %eax
  80219e:	6a 1a                	push   $0x1a
  8021a0:	e8 e1 fc ff ff       	call   801e86 <syscall>
...
008021ab <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8021b7:	8b 4d 14             	mov    0x14(%ebp),%ecx
  8021ba:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8021c8:	50                   	push   %eax
  8021c9:	6a 1c                	push   $0x1c
  8021cb:	e8 b6 fc ff ff       	call   801e86 <syscall>
  8021d0:	83 c4 18             	add    $0x18,%esp
}
  8021d3:	c9                   	leave  
  8021d4:	c3                   	ret    

008021d5 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  8021e4:	52                   	push   %edx
  8021e5:	50                   	push   %eax
  8021e6:	6a 1d                	push   $0x1d
  8021e8:	e8 99 fc ff ff       	call   801e86 <syscall>
  8021ed:	83 c4 18             	add    $0x18,%esp
}
  8021f0:	c9                   	leave  
  8021f1:	c3                   	ret    

008021f2 <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  8021f5:	8b 4d 10             	mov    0x10(%ebp),%ecx
  ...
  802207:	e8 7a fc ff ff       	call   801e86 <syscall>
  80220c:	83 c4 18             	add    $0x18,%esp
}
  80220f:	c9                   	leave  
  802210:	c3                   	ret    

00802211 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  802220:	52                   	push   %edx
  802221:	50                   	push   %eax
  802222:	6a 1f                	push   $0x1f
  802224:	e8 5d fc ff ff       	call   801e86 <syscall>
  802229:	83 c4 18             	add    $0x18,%esp
}
  80222c:	c9                   	leave  
  80222d:	c3                   	ret    

0080222e <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  80223b:	6a 20                	push   $0x20
  80223d:	e8 44 fc ff ff       	call   801e86 <syscall>
  802242:	83 c4 18             	add    $0x18,%esp
}
  802245:	c9                   	leave  
  802246:	c3                   	ret    

00802247 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80224f:	ff 75 14             	pushl  0x14(%ebp)
  802252:	ff 75 10             	pushl  0x10(%ebp)
  802255:	ff 75 0c             	pushl  0xc(%ebp)
  802258:	50                   	push   %eax
  802259:	6a 21                	push   $0x21
  80225b:	e8 26 fc ff ff       	call   801e86 <syscall>
  802260:	83 c4 18             	add    $0x18,%esp
}
  802263:	c9                   	leave  
  802264:	c3                   	ret    

00802265 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  802273:	50                   	push   %eax
  802274:	6a 22                	push   $0x22
  802276:	e8 0b fc ff ff       	call   801e86 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80228f:	50                   	push   %eax
  802290:	6a 23                	push   $0x23
  802292:	e8 ef fb ff ff       	call   801e86 <syscall>
...
sys_get_virtual_time()
{
  ...
  8022a3:	8d 45 f8             	lea    -0x8(%ebp),%eax
  8022a6:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  8022b2:	52                   	push   %edx
  8022b3:	50                   	push   %eax
  8022b4:	6a 24                	push   $0x24
  8022b6:	e8 cb fb ff ff       	call   801e86 <syscall>
  8022bb:	83 c4 18             	add    $0x18,%esp
	return result;
  8022be:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8022c1:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8022c4:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8022c7:	89 01                	mov    %eax,(%ecx)
  8022c9:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8022cc:	8b 45 08             	mov    0x8(%ebp),%eax
  8022cf:	c9                   	leave  
  8022d0:	c2 04 00             	ret    $0x4

008022d3 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8022e3:	6a 13                	push   $0x13
  8022e5:	e8 9c fb ff ff       	call   801e86 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8022fd:	6a 25                	push   $0x25
  8022ff:	e8 82 fb ff ff       	call   801e86 <syscall>
  802304:	83 c4 18             	add    $0x18,%esp
}
  802307:	c9                   	leave  
  802308:	c3                   	ret    

00802309 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  802312:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_bypassPageFault, instrLength, 0, 0, 0, 0);
  802315:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  802319:	6a 00                	push   $0x0
  80231b:	6a 00                	push   $0x0
  80231d:	6a 00                	push   $0x0
  80231f:	6a 00                	push   $0x0
  802321:	50                   	push   %eax
  802322:	6a 26                	push   $0x26
  802324:	e8 5d fb ff ff       	call   801e86 <syscall>
...
void rsttst()
{
  ...
  80233c:	6a 28                	push   $0x28
  80233e:	e8 43 fb ff ff       	call   801e86 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  802355:	8b 55 18             	mov    0x18(%ebp),%edx
  802358:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  80235c:	52                   	push   %edx
  80235d:	50                   	push   %eax
  80235e:	ff 75 10             	pushl  0x10(%ebp)
  802361:	ff 75 0c             	pushl  0xc(%ebp)
  802364:	ff 75 08             	pushl  0x8(%ebp)
  802367:	6a 27                	push   $0x27
  802369:	e8 18 fb ff ff       	call   801e86 <syscall>
...
void chktst(uint32 n)
{
  ...
  802382:	6a 29                	push   $0x29
  802384:	e8 fd fa ff ff       	call   801e86 <syscall>
...
void inctst()
{
  ...
  80239c:	6a 2a                	push   $0x2a
  80239e:	e8 e3 fa ff ff       	call   801e86 <syscall>
...
uint32 gettst()
{
  ...
  8023b6:	6a 2b                	push   $0x2b
  8023b8:	e8 c9 fa ff ff       	call   801e86 <syscall>
  8023bd:	83 c4 18             	add    $0x18,%esp
}
  8023c0:	c9                   	leave  
  8023c1:	c3                   	ret    

008023c2 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8023d2:	6a 2c                	push   $0x2c
  8023d4:	e8 ad fa ff ff       	call   801e86 <syscall>
  8023d9:	83 c4 18             	add    $0x18,%esp
  8023dc:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8023df:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8023e3:	75 07                	jne    8023ec <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8023e5:	b8 01 00 00 00       	mov    $0x1,%eax
  8023ea:	eb 05                	jmp    8023f1 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008023f3 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  802405:	e8 7c fa ff ff       	call   801e86 <syscall>
  80240a:	83 c4 18             	add    $0x18,%esp
  80240d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  802410:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  802414:	75 07                	jne    80241d <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  802416:	b8 01 00 00 00       	mov    $0x1,%eax
  80241b:	eb 05                	jmp    802422 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00802424 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  802436:	e8 4b fa ff ff       	call   801e86 <syscall>
  80243b:	83 c4 18             	add    $0x18,%esp
  80243e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  802441:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  802445:	75 07                	jne    80244e <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  802447:	b8 01 00 00 00       	mov    $0x1,%eax
  80244c:	eb 05                	jmp    802453 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00802455 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  802467:	e8 1a fa ff ff       	call   801e86 <syscall>
  80246c:	83 c4 18             	add    $0x18,%esp
  80246f:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  802472:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  802476:	75 07                	jne    80247f <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  802478:	b8 01 00 00 00       	mov    $0x1,%eax
  80247d:	eb 05                	jmp    802484 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00802486 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  802494:	6a 2d                	push   $0x2d
  802496:	e8 eb f9 ff ff       	call   801e86 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8024a5:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  8024b5:	52                   	push   %edx
  8024b6:	50                   	push   %eax
  8024b7:	6a 2e                	push   $0x2e
  8024b9:	e8 c8 f9 ff ff       	call   801e86 <syscall>
...
008024c6 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8024d5:	52                   	push   %edx
  8024d6:	50                   	push   %eax
  8024d7:	6a 2f                	push   $0x2f
  8024d9:	e8 a8 f9 ff ff       	call   801e86 <syscall>
