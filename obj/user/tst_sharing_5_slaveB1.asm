...
_main(void)
{
  ...
  8000d8:	e8 e0 1c 00 00       	call   801dbd <env_sleep>
  8000dd:	83 c4 10             	add    $0x10,%esp
	int freeFrames = sys_calculate_free_frames() ;
  8000e0:	e8 e7 17 00 00       	call   8018cc <sys_calculate_free_frames>
  8000e5:	89 45 e8             	mov    %eax,-0x18(%ebp)

	sfree(x);
  8000e8:	83 ec 0c             	sub    $0xc,%esp
  8000eb:	ff 75 ec             	pushl  -0x14(%ebp)
  8000ee:	e8 69 15 00 00       	call   80165c <sfree>
  8000f3:	83 c4 10             	add    $0x10,%esp
	cprintf("Slave B1 env removed x\n");
  8000f6:	83 ec 0c             	sub    $0xc,%esp
  8000f9:	68 64 21 80 00       	push   $0x802164
  ...
  800106:	e8 c1 17 00 00       	call   8018cc <sys_calculate_free_frames>
  ...
  80011c:	68 7c 21 80 00       	push   $0x80217c
  ...
  800128:	e8 4d 01 00 00       	call   80027a <_panic>
	...
	inctst();
  80012d:	e8 37 1b 00 00       	call   801c69 <inctst>
	return;
  800132:	90                   	nop
}
  800133:	c9                   	leave  
...
libmain(int argc, char **argv)
{
  ...
  80013b:	e8 c1 16 00 00       	call   801801 <sys_getenvindex>
  ...
  8001b8:	e8 df 17 00 00       	call   80199c <sys_disable_interrupt>
	cprintf("**************************************\n");
  8001bd:	83 ec 0c             	sub    $0xc,%esp
  8001c0:	68 3c 22 80 00       	push   $0x80223c
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 64 22 80 00       	push   $0x802264
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 8c 22 80 00       	push   $0x80228c
...
destroy(void)
{
  ...
  800261:	e8 67 15 00 00       	call   8017cd <sys_env_destroy>
...
exit(void)
{
  ...
  80026f:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800272:	e8 bc 15 00 00       	call   801833 <sys_env_exit>
}
  800277:	90                   	nop
  800278:	c9                   	leave  
  800279:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 e4 22 80 00       	push   $0x8022e4
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 e9 22 80 00       	push   $0x8022e9
  ...
  8002d8:	68 05 23 80 00       	push   $0x802305
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 08 23 80 00       	push   $0x802308
  800309:	6a 26                	push   $0x26
  80030b:	68 54 23 80 00       	push   $0x802354
  ...
  8003ca:	68 60 23 80 00       	push   $0x802360
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 54 23 80 00       	push   $0x802354
  ...
  800434:	68 b4 23 80 00       	push   $0x8023b4
  800439:	6a 44                	push   $0x44
  80043b:	68 54 23 80 00       	push   $0x802354
...
static void putch(int ch, struct printbuf *b) {
  ...
  80048c:	51                   	push   %ecx
  80048d:	52                   	push   %edx
  80048e:	e8 f8 12 00 00       	call   80178b <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800504:	50                   	push   %eax
  800505:	e8 81 12 00 00       	call   80178b <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  80054c:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80054f:	e8 48 14 00 00       	call   80199c <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  80056c:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  80056f:	e8 42 14 00 00       	call   8019b6 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005b9:	e8 b6 18 00 00       	call   801e74 <__udivdi3>
  ...
  800607:	52                   	push   %edx
  800608:	50                   	push   %eax
  800609:	e8 76 19 00 00       	call   801f84 <__umoddi3>
  80060e:	83 c4 10             	add    $0x10,%esp
  800611:	05 14 26 80 00       	add    $0x802614,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 38 26 80 00 	mov    0x802638(,%eax,4),%eax
  ...
  800845:	8b 34 9d 80 24 80 00 	mov    0x802480(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 25 26 80 00       	push   $0x802625
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 2e 26 80 00       	push   $0x80262e
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be 31 26 80 00       	mov    $0x802631,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  8012a9:	83 ec 18             	sub    $0x18,%esp
	...
	free_mem_count=0;
  8012ac:	c7 05 4c 31 80 00 00 	movl   $0x0,0x80314c
  8012b3:	00 00 00 
	//BOOL VARIABLE check is there suitable space or not
	find=0;
  8012b6:	c7 05 48 31 80 00 00 	movl   $0x0,0x803148
  8012bd:	00 00 00 
	// Initialize user heap memory (1GB = 2^30)->MAX_NUM
	if(intialize_mem==0)
  8012c0:	a1 28 30 80 00       	mov    0x803028,%eax
  8012c5:	85 c0                	test   %eax,%eax
  8012c7:	75 65                	jne    80132e <malloc+0x88>
	{
		for(j=USER_HEAP_START;j<USER_HEAP_MAX;j+=PAGE_SIZE)
  8012c9:	c7 05 2c 31 80 00 00 	movl   $0x80000000,0x80312c
  8012d0:	00 00 80 
  8012d3:	eb 43                	jmp    801318 <malloc+0x72>
		{
			pages[array_size].address=j; // store start address of each 4k(Page_size)
  8012d5:	8b 15 2c 30 80 00    	mov    0x80302c,%edx
  8012db:	a1 2c 31 80 00       	mov    0x80312c,%eax
  8012e0:	c1 e2 04             	shl    $0x4,%edx
  8012e3:	81 c2 60 31 80 00    	add    $0x803160,%edx
  8012e9:	89 02                	mov    %eax,(%edx)
			pages[array_size].used=0;//not used
  8012eb:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8012f0:	c1 e0 04             	shl    $0x4,%eax
  8012f3:	05 64 31 80 00       	add    $0x803164,%eax
  8012f8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			array_size+=1;
  8012fe:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801303:	40                   	inc    %eax
  801304:	a3 2c 30 80 00       	mov    %eax,0x80302c
	//BOOL VARIABLE check is there suitable space or not
	find=0;
	// Initialize user heap memory (1GB = 2^30)->MAX_NUM
	if(intialize_mem==0)
	{
		for(j=USER_HEAP_START;j<USER_HEAP_MAX;j+=PAGE_SIZE)
  801309:	a1 2c 31 80 00       	mov    0x80312c,%eax
  80130e:	05 00 10 00 00       	add    $0x1000,%eax
  801313:	a3 2c 31 80 00       	mov    %eax,0x80312c
  801318:	a1 2c 31 80 00       	mov    0x80312c,%eax
  80131d:	3d ff ff ff 9f       	cmp    $0x9fffffff,%eax
  801322:	76 b1                	jbe    8012d5 <malloc+0x2f>
		{
			pages[array_size].address=j; // store start address of each 4k(Page_size)
			pages[array_size].used=0;//not used
			array_size+=1;
		...
		intialize_mem=1;
  801324:	c7 05 28 30 80 00 01 	movl   $0x1,0x803028
  80132b:	00 00 00 
	}
	be_space=MAX_NUM;
  80132e:	c7 05 5c 31 80 00 00 	movl   $0x40000000,0x80315c
  801335:	00 00 40 
	//find upper limit of size and calculate num of pages with given size
	round=ROUNDUP(size/1024,4);
  801338:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  80133f:	8b 45 08             	mov    0x8(%ebp),%eax
  801342:	c1 e8 0a             	shr    $0xa,%eax
  ...
  801358:	f7 75 f4             	divl   -0xc(%ebp)
  80135b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80135e:	29 d0                	sub    %edx,%eax
  801360:	a3 28 31 80 00       	mov    %eax,0x803128
	no_of_pages=round/4;
  801365:	a1 28 31 80 00       	mov    0x803128,%eax
  80136a:	c1 e8 02             	shr    $0x2,%eax
  80136d:	a3 60 31 a0 00       	mov    %eax,0xa03160
	// find empty spaces in user heap mem
	for(j=0;j<array_size;++j)
  801372:	c7 05 2c 31 80 00 00 	movl   $0x0,0x80312c
  801379:	00 00 00 
  80137c:	e9 96 00 00 00       	jmp    801417 <malloc+0x171>
	{
		if(pages[j].used==0) //check empty pages
  801381:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801386:	c1 e0 04             	shl    $0x4,%eax
  801389:	05 64 31 80 00       	add    $0x803164,%eax
  80138e:	8b 00                	mov    (%eax),%eax
  801390:	85 c0                	test   %eax,%eax
  801392:	75 2a                	jne    8013be <malloc+0x118>
		{
			//first empty space only
			if(free_mem_count==0)
  801394:	a1 4c 31 80 00       	mov    0x80314c,%eax
  801399:	85 c0                	test   %eax,%eax
  80139b:	75 14                	jne    8013b1 <malloc+0x10b>
			{
				first_empty_space=pages[j].address;
  80139d:	a1 2c 31 80 00       	mov    0x80312c,%eax
  8013a2:	c1 e0 04             	shl    $0x4,%eax
  8013a5:	05 60 31 80 00       	add    $0x803160,%eax
  8013aa:	8b 00                	mov    (%eax),%eax
  8013ac:	a3 30 31 80 00       	mov    %eax,0x803130
			}
			free_mem_count++; // increment num of free spaces
  8013b1:	a1 4c 31 80 00       	mov    0x80314c,%eax
  8013b6:	40                   	inc    %eax
  8013b7:	a3 4c 31 80 00       	mov    %eax,0x80314c
  8013bc:	eb 4e                	jmp    80140c <malloc+0x166>
		}
		else //pages[j].used!=0(==1)used
		{
			// best fit strategy
			emp_space=free_mem_count*PAGE_SIZE;
  8013be:	a1 4c 31 80 00       	mov    0x80314c,%eax
  8013c3:	c1 e0 0c             	shl    $0xc,%eax
  8013c6:	a3 34 31 80 00       	mov    %eax,0x803134
			// find min space to fit given size in array
			if(be_space>emp_space&&emp_space>=size)
  8013cb:	8b 15 5c 31 80 00    	mov    0x80315c,%edx
  8013d1:	a1 34 31 80 00       	mov    0x803134,%eax
  8013d6:	39 c2                	cmp    %eax,%edx
  8013d8:	76 28                	jbe    801402 <malloc+0x15c>
  8013da:	a1 34 31 80 00       	mov    0x803134,%eax
  8013df:	3b 45 08             	cmp    0x8(%ebp),%eax
  8013e2:	72 1e                	jb     801402 <malloc+0x15c>
			{
				// reset min value to repeat condition to find suitable space (ms7 mosawi2 aw2kbr b shwi2)
				be_space=emp_space;
  8013e4:	a1 34 31 80 00       	mov    0x803134,%eax
  8013e9:	a3 5c 31 80 00       	mov    %eax,0x80315c
				// set start address of empty space
				be_address=first_empty_space;
  8013ee:	a1 30 31 80 00       	mov    0x803130,%eax
  8013f3:	a3 58 31 80 00       	mov    %eax,0x803158
				find=1;
  8013f8:	c7 05 48 31 80 00 01 	movl   $0x1,0x803148
  8013ff:	00 00 00 
			}
			free_mem_count=0;
  801402:	c7 05 4c 31 80 00 00 	movl   $0x0,0x80314c
  801409:	00 00 00 
	be_space=MAX_NUM;
	//find upper limit of size and calculate num of pages with given size
	round=ROUNDUP(size/1024,4);
	...
	// find empty spaces in user heap mem
	for(j=0;j<array_size;++j)
  80140c:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801411:	40                   	inc    %eax
  801412:	a3 2c 31 80 00       	mov    %eax,0x80312c
  801417:	8b 15 2c 31 80 00    	mov    0x80312c,%edx
  80141d:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801422:	39 c2                	cmp    %eax,%edx
  801424:	0f 82 57 ff ff ff    	jb     801381 <malloc+0xdb>
			}
			free_mem_count=0;
		}
	}
	...
	emp_space=free_mem_count*PAGE_SIZE;
  80142a:	a1 4c 31 80 00       	mov    0x80314c,%eax
  80142f:	c1 e0 0c             	shl    $0xc,%eax
  801432:	a3 34 31 80 00       	mov    %eax,0x803134
	// check if this empty space suitable to fit given size or not
	if(be_space>emp_space&&emp_space>=size)
  801437:	8b 15 5c 31 80 00    	mov    0x80315c,%edx
  80143d:	a1 34 31 80 00       	mov    0x803134,%eax
  801442:	39 c2                	cmp    %eax,%edx
  801444:	76 1e                	jbe    801464 <malloc+0x1be>
  801446:	a1 34 31 80 00       	mov    0x803134,%eax
  80144b:	3b 45 08             	cmp    0x8(%ebp),%eax
  80144e:	72 14                	jb     801464 <malloc+0x1be>
	{
		find=1;
  801450:	c7 05 48 31 80 00 01 	movl   $0x1,0x803148
  801457:	00 00 00 
		// set final start address of empty space
		be_address=first_empty_space;
  80145a:	a1 30 31 80 00       	mov    0x803130,%eax
  80145f:	a3 58 31 80 00       	mov    %eax,0x803158
	}
	if(find==0) // no suitable space found
  801464:	a1 48 31 80 00       	mov    0x803148,%eax
  801469:	85 c0                	test   %eax,%eax
  80146b:	75 0a                	jne    801477 <malloc+0x1d1>
	{
		return NULL;
  80146d:	b8 00 00 00 00       	mov    $0x0,%eax
  801472:	e9 fa 00 00 00       	jmp    801571 <malloc+0x2cb>
	}
	for(j=0;j<array_size;++j)
  801477:	c7 05 2c 31 80 00 00 	movl   $0x0,0x80312c
  80147e:	00 00 00 
  801481:	eb 2f                	jmp    8014b2 <malloc+0x20c>
	{
		if (pages[j].address==be_address)
  801483:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801488:	c1 e0 04             	shl    $0x4,%eax
  80148b:	05 60 31 80 00       	add    $0x803160,%eax
  801490:	8b 10                	mov    (%eax),%edx
  801492:	a1 58 31 80 00       	mov    0x803158,%eax
  801497:	39 c2                	cmp    %eax,%edx
  801499:	75 0c                	jne    8014a7 <malloc+0x201>
		{
			index=j;
  80149b:	a1 2c 31 80 00       	mov    0x80312c,%eax
  8014a0:	a3 50 31 80 00       	mov    %eax,0x803150
			break;
  8014a5:	eb 1a                	jmp    8014c1 <malloc+0x21b>
	}
	if(find==0) // no suitable space found
	{
		return NULL;
	...
	for(j=0;j<array_size;++j)
  8014a7:	a1 2c 31 80 00       	mov    0x80312c,%eax
  8014ac:	40                   	inc    %eax
  8014ad:	a3 2c 31 80 00       	mov    %eax,0x80312c
  8014b2:	8b 15 2c 31 80 00    	mov    0x80312c,%edx
  8014b8:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8014bd:	39 c2                	cmp    %eax,%edx
  8014bf:	72 c2                	jb     801483 <malloc+0x1dd>
			index=j;
			break;
		}
	}
  ...
  8014c1:	8b 15 50 31 80 00    	mov    0x803150,%edx
  8014c7:	a1 60 31 a0 00       	mov    0xa03160,%eax
  8014cc:	c1 e2 04             	shl    $0x4,%edx
  8014cf:	81 c2 68 31 80 00    	add    $0x803168,%edx
  8014d5:	89 02                	mov    %eax,(%edx)
	pages[index].siize=size;
  8014d7:	a1 50 31 80 00       	mov    0x803150,%eax
  8014dc:	c1 e0 04             	shl    $0x4,%eax
  8014df:	8d 90 6c 31 80 00    	lea    0x80316c(%eax),%edx
  8014e5:	8b 45 08             	mov    0x8(%ebp),%eax
  8014e8:	89 02                	mov    %eax,(%edx)
	ind=index;
  8014ea:	a1 50 31 80 00       	mov    0x803150,%eax
  8014ef:	a3 3c 31 80 00       	mov    %eax,0x80313c

	// loop in n to reset used value to 1 b3add l pages
	for(j=0;j<no_of_pages;++j)
  8014f4:	c7 05 2c 31 80 00 00 	movl   $0x0,0x80312c
  8014fb:	00 00 00 
  8014fe:	eb 29                	jmp    801529 <malloc+0x283>
	{
		pages[index].used=1;
  801500:	a1 50 31 80 00       	mov    0x803150,%eax
  801505:	c1 e0 04             	shl    $0x4,%eax
  801508:	05 64 31 80 00       	add    $0x803164,%eax
  80150d:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
		++index;
  801513:	a1 50 31 80 00       	mov    0x803150,%eax
  801518:	40                   	inc    %eax
  801519:	a3 50 31 80 00       	mov    %eax,0x803150
	pages[index].num_of_pages=no_of_pages;
	pages[index].siize=size;
	ind=index;
	...
	// loop in n to reset used value to 1 b3add l pages
	for(j=0;j<no_of_pages;++j)
  80151e:	a1 2c 31 80 00       	mov    0x80312c,%eax
  801523:	40                   	inc    %eax
  801524:	a3 2c 31 80 00       	mov    %eax,0x80312c
  801529:	8b 15 2c 31 80 00    	mov    0x80312c,%edx
  80152f:	a1 60 31 a0 00       	mov    0xa03160,%eax
  801534:	39 c2                	cmp    %eax,%edx
  801536:	72 c8                	jb     801500 <malloc+0x25a>
	{
		pages[index].used=1;
		++index;
	}
  ...
  801538:	a1 58 31 80 00       	mov    0x803158,%eax
  80153d:	83 ec 08             	sub    $0x8,%esp
  801540:	ff 75 08             	pushl  0x8(%ebp)
  801543:	50                   	push   %eax
  801544:	e8 ea 03 00 00       	call   801933 <sys_allocateMem>
  801549:	83 c4 10             	add    $0x10,%esp
	ad = be_address;
  80154c:	a1 58 31 80 00       	mov    0x803158,%eax
  801551:	a3 20 31 80 00       	mov    %eax,0x803120
	si = size/2;
  801556:	8b 45 08             	mov    0x8(%ebp),%eax
  801559:	d1 e8                	shr    %eax
  80155b:	a3 38 31 80 00       	mov    %eax,0x803138
	nump = no_of_pages/2;
  801560:	a1 60 31 a0 00       	mov    0xa03160,%eax
  801565:	d1 e8                	shr    %eax
  801567:	a3 40 31 80 00       	mov    %eax,0x803140
...
int index;
  ...
  801579:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801580:	eb 1d                	jmp    80159f <free+0x2c>
	{
		if((void *)pages[i].address == virtual_address)
  801582:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801585:	c1 e0 04             	shl    $0x4,%eax
  801588:	05 60 31 80 00       	add    $0x803160,%eax
  80158d:	8b 00                	mov    (%eax),%eax
  80158f:	3b 45 08             	cmp    0x8(%ebp),%eax
  801592:	75 08                	jne    80159c <free+0x29>
		{
			index = i;
  801594:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801597:	89 45 f4             	mov    %eax,-0xc(%ebp)
			break;
  80159a:	eb 0f                	jmp    8015ab <free+0x38>
uint32 size, maxmam_size,fif;
void free(void* virtual_address)
{
int index;
	//found index of virtual address
	for(int i=0;i<array_size;i++)
  80159c:	ff 45 f0             	incl   -0x10(%ebp)
  80159f:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8015a2:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8015a7:	39 c2                	cmp    %eax,%edx
  8015a9:	72 d7                	jb     801582 <free+0xf>
			break;
		}
	}
  ...
  8015b1:	05 68 31 80 00       	add    $0x803168,%eax
  ...
  8015c1:	05 68 31 80 00       	add    $0x803168,%eax
  ...
  8015d2:	05 60 31 80 00       	add    $0x803160,%eax
  8015d7:	8b 00                	mov    (%eax),%eax
  8015d9:	89 45 e4             	mov    %eax,-0x1c(%ebp)

	//set used to 0
	for(int i=0;i<num_of_pages;i++)
  8015dc:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8015e3:	eb 17                	jmp    8015fc <free+0x89>
	{
		pages[index].used=0;
  8015e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8015e8:	c1 e0 04             	shl    $0x4,%eax
  8015eb:	05 64 31 80 00       	add    $0x803164,%eax
  8015f0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		index++;
  8015f6:	ff 45 f4             	incl   -0xc(%ebp)
	int num_of_pages = pages[index].num_of_pages;
	pages[index].num_of_pages=0;
	uint32 va = pages[index].address;
	...
	//set used to 0
	for(int i=0;i<num_of_pages;i++)
  8015f9:	ff 45 ec             	incl   -0x14(%ebp)
  8015fc:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8015ff:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801602:	7c e1                	jl     8015e5 <free+0x72>
	{
		pages[index].used=0;
		index++;
	}
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801625:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801628:	83 ec 04             	sub    $0x4,%esp
  80162b:	68 90 27 80 00       	push   $0x802790
  801630:	68 a0 00 00 00       	push   $0xa0
  801635:	68 b3 27 80 00       	push   $0x8027b3
  80163a:	e8 3b ec ff ff       	call   80027a <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801648:	68 90 27 80 00       	push   $0x802790
  80164d:	68 a6 00 00 00       	push   $0xa6
  801652:	68 b3 27 80 00       	push   $0x8027b3
  801657:	e8 1e ec ff ff       	call   80027a <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801665:	68 90 27 80 00       	push   $0x802790
  80166a:	68 ac 00 00 00       	push   $0xac
  80166f:	68 b3 27 80 00       	push   $0x8027b3
  801674:	e8 01 ec ff ff       	call   80027a <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801682:	68 90 27 80 00       	push   $0x802790
  801687:	68 b1 00 00 00       	push   $0xb1
  80168c:	68 b3 27 80 00       	push   $0x8027b3
  801691:	e8 e4 eb ff ff       	call   80027a <_panic>
...
void expand(uint32 newSize)
{
  ...
  80169f:	68 90 27 80 00       	push   $0x802790
  8016a4:	68 b7 00 00 00       	push   $0xb7
  8016a9:	68 b3 27 80 00       	push   $0x8027b3
  8016ae:	e8 c7 eb ff ff       	call   80027a <_panic>
...
void shrink(uint32 newSize)
{
  ...
  8016bc:	68 90 27 80 00       	push   $0x802790
  8016c1:	68 bb 00 00 00       	push   $0xbb
  8016c6:	68 b3 27 80 00       	push   $0x8027b3
  8016cb:	e8 aa eb ff ff       	call   80027a <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  8016d9:	68 90 27 80 00       	push   $0x802790
  8016de:	68 c0 00 00 00       	push   $0xc0
  8016e3:	68 b3 27 80 00       	push   $0x8027b3
  8016e8:	e8 8d eb ff ff       	call   80027a <_panic>
...
void halfLast(){
  ...
  8016f3:	a1 20 31 80 00       	mov    0x803120,%eax
  8016f8:	8b 15 38 31 80 00    	mov    0x803138,%edx
  8016fe:	01 d0                	add    %edx,%eax
  801700:	89 45 f0             	mov    %eax,-0x10(%ebp)
	ind+=nump;
  801703:	8b 15 3c 31 80 00    	mov    0x80313c,%edx
  801709:	a1 40 31 80 00       	mov    0x803140,%eax
  80170e:	01 d0                	add    %edx,%eax
  801710:	a3 3c 31 80 00       	mov    %eax,0x80313c
	for(int i=0;i<nump;i++){
  801715:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80171c:	eb 21                	jmp    80173f <halfLast+0x52>
		pages[ind].used=0;
  80171e:	a1 3c 31 80 00       	mov    0x80313c,%eax
  801723:	c1 e0 04             	shl    $0x4,%eax
  801726:	05 64 31 80 00       	add    $0x803164,%eax
  80172b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		ind++;
  801731:	a1 3c 31 80 00       	mov    0x80313c,%eax
  801736:	40                   	inc    %eax
  801737:	a3 3c 31 80 00       	mov    %eax,0x80313c
		pages[va].used=0;
		va+=PAGE_SIZE;
	}*/
	uint32 halfAdd = ad+si;
	ind+=nump;
	for(int i=0;i<nump;i++){
  80173c:	ff 45 f4             	incl   -0xc(%ebp)
  80173f:	a1 40 31 80 00       	mov    0x803140,%eax
  801744:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801747:	7c d5                	jl     80171e <halfLast+0x31>
		pages[ind].used=0;
		ind++;
	}
	sys_freeMem(halfAdd,si);
  801749:	a1 38 31 80 00       	mov    0x803138,%eax
  80174e:	83 ec 08             	sub    $0x8,%esp
  801751:	50                   	push   %eax
  801752:	ff 75 f0             	pushl  -0x10(%ebp)
  801755:	e8 bd 01 00 00       	call   801917 <sys_freeMem>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801775:	8b 7d 18             	mov    0x18(%ebp),%edi
  801778:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801797:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8017a9:	e8 b2 ff ff ff       	call   801760 <syscall>
...
sys_cgetc(void)
{
  ...
  8017c3:	e8 98 ff ff ff       	call   801760 <syscall>
  8017c8:	83 c4 18             	add    $0x18,%esp
}
  8017cb:	c9                   	leave  
  8017cc:	c3                   	ret    

008017cd <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  8017db:	50                   	push   %eax
  8017dc:	6a 05                	push   $0x5
  8017de:	e8 7d ff ff ff       	call   801760 <syscall>
  8017e3:	83 c4 18             	add    $0x18,%esp
}
  8017e6:	c9                   	leave  
  8017e7:	c3                   	ret    

008017e8 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  8017f7:	e8 64 ff ff ff       	call   801760 <syscall>
  8017fc:	83 c4 18             	add    $0x18,%esp
}
  8017ff:	c9                   	leave  
  801800:	c3                   	ret    

00801801 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  80180e:	6a 03                	push   $0x3
  801810:	e8 4b ff ff ff       	call   801760 <syscall>
  801815:	83 c4 18             	add    $0x18,%esp
}
  801818:	c9                   	leave  
  801819:	c3                   	ret    

0080181a <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801827:	6a 04                	push   $0x4
  801829:	e8 32 ff ff ff       	call   801760 <syscall>
  80182e:	83 c4 18             	add    $0x18,%esp
}
  801831:	c9                   	leave  
  801832:	c3                   	ret    

00801833 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801840:	6a 06                	push   $0x6
  801842:	e8 19 ff ff ff       	call   801760 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801860:	e8 fb fe ff ff       	call   801760 <syscall>
  801865:	83 c4 18             	add    $0x18,%esp
}
  801868:	c9                   	leave  
  801869:	c3                   	ret    

0080186a <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  80186f:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  801885:	e8 d6 fe ff ff       	call   801760 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  8018a7:	e8 b4 fe ff ff       	call   801760 <syscall>
  8018ac:	83 c4 18             	add    $0x18,%esp
}
  8018af:	c9                   	leave  
  8018b0:	c3                   	ret    

008018b1 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  8018c0:	6a 0a                	push   $0xa
  8018c2:	e8 99 fe ff ff       	call   801760 <syscall>
  8018c7:	83 c4 18             	add    $0x18,%esp
}
  8018ca:	c9                   	leave  
  8018cb:	c3                   	ret    

008018cc <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  8018d9:	6a 0b                	push   $0xb
  8018db:	e8 80 fe ff ff       	call   801760 <syscall>
  8018e0:	83 c4 18             	add    $0x18,%esp
}
  8018e3:	c9                   	leave  
  8018e4:	c3                   	ret    

008018e5 <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  8018f2:	6a 0c                	push   $0xc
  8018f4:	e8 67 fe ff ff       	call   801760 <syscall>
  8018f9:	83 c4 18             	add    $0x18,%esp
}
  8018fc:	c9                   	leave  
  8018fd:	c3                   	ret    

008018fe <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  80190b:	6a 0d                	push   $0xd
  80190d:	e8 4e fe ff ff       	call   801760 <syscall>
  801912:	83 c4 18             	add    $0x18,%esp
}
  801915:	c9                   	leave  
  801916:	c3                   	ret    

00801917 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801928:	e8 33 fe ff ff       	call   801760 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801942:	6a 12                	push   $0x12
  801944:	e8 17 fe ff ff       	call   801760 <syscall>
...
0080194f <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  80195c:	6a 0e                	push   $0xe
  80195e:	e8 fd fd ff ff       	call   801760 <syscall>
  801963:	83 c4 18             	add    $0x18,%esp
}
  801966:	c9                   	leave  
  801967:	c3                   	ret    

00801968 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801976:	6a 0f                	push   $0xf
  801978:	e8 e3 fd ff ff       	call   801760 <syscall>
  80197d:	83 c4 18             	add    $0x18,%esp
}
  801980:	c9                   	leave  
  801981:	c3                   	ret    

00801982 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  80198f:	6a 10                	push   $0x10
  801991:	e8 ca fd ff ff       	call   801760 <syscall>
...
0080199c <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  8019a9:	6a 14                	push   $0x14
  8019ab:	e8 b0 fd ff ff       	call   801760 <syscall>
...
sys_enable_interrupt()
{
  ...
  8019c3:	6a 15                	push   $0x15
  8019c5:	e8 96 fd ff ff       	call   801760 <syscall>
...
sys_cputc(const char c)
{
  ...
  8019eb:	e8 70 fd ff ff       	call   801760 <syscall>
...
sys_clear_ffl()
{
  ...
  801a05:	e8 56 fd ff ff       	call   801760 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801a22:	e8 39 fd ff ff       	call   801760 <syscall>
  801a27:	83 c4 18             	add    $0x18,%esp
}
  801a2a:	c9                   	leave  
  801a2b:	c3                   	ret    

00801a2c <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801a3b:	52                   	push   %edx
  801a3c:	50                   	push   %eax
  801a3d:	6a 1b                	push   $0x1b
  801a3f:	e8 1c fd ff ff       	call   801760 <syscall>
  801a44:	83 c4 18             	add    $0x18,%esp
}
  801a47:	c9                   	leave  
  801a48:	c3                   	ret    

00801a49 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801a58:	52                   	push   %edx
  801a59:	50                   	push   %eax
  801a5a:	6a 19                	push   $0x19
  801a5c:	e8 ff fc ff ff       	call   801760 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801a7a:	e8 e1 fc ff ff       	call   801760 <syscall>
...
00801a85 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801a94:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801aa2:	50                   	push   %eax
  801aa3:	6a 1c                	push   $0x1c
  801aa5:	e8 b6 fc ff ff       	call   801760 <syscall>
  801aaa:	83 c4 18             	add    $0x18,%esp
}
  801aad:	c9                   	leave  
  801aae:	c3                   	ret    

00801aaf <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  801ac2:	e8 99 fc ff ff       	call   801760 <syscall>
  801ac7:	83 c4 18             	add    $0x18,%esp
}
  801aca:	c9                   	leave  
  801acb:	c3                   	ret    

00801acc <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801ae1:	e8 7a fc ff ff       	call   801760 <syscall>
  801ae6:	83 c4 18             	add    $0x18,%esp
}
  801ae9:	c9                   	leave  
  801aea:	c3                   	ret    

00801aeb <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  801afe:	e8 5d fc ff ff       	call   801760 <syscall>
  801b03:	83 c4 18             	add    $0x18,%esp
}
  801b06:	c9                   	leave  
  801b07:	c3                   	ret    

00801b08 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801b15:	6a 20                	push   $0x20
  801b17:	e8 44 fc ff ff       	call   801760 <syscall>
  801b1c:	83 c4 18             	add    $0x18,%esp
}
  801b1f:	c9                   	leave  
  801b20:	c3                   	ret    

00801b21 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801b32:	50                   	push   %eax
  801b33:	6a 21                	push   $0x21
  801b35:	e8 26 fc ff ff       	call   801760 <syscall>
  801b3a:	83 c4 18             	add    $0x18,%esp
}
  801b3d:	c9                   	leave  
  801b3e:	c3                   	ret    

00801b3f <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801b50:	e8 0b fc ff ff       	call   801760 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801b69:	50                   	push   %eax
  801b6a:	6a 23                	push   $0x23
  801b6c:	e8 ef fb ff ff       	call   801760 <syscall>
...
sys_get_virtual_time()
{
  ...
  801b8c:	52                   	push   %edx
  801b8d:	50                   	push   %eax
  801b8e:	6a 24                	push   $0x24
  801b90:	e8 cb fb ff ff       	call   801760 <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801bbf:	e8 9c fb ff ff       	call   801760 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801bd9:	e8 82 fb ff ff       	call   801760 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801bfe:	e8 5d fb ff ff       	call   801760 <syscall>
...
void rsttst()
{
  ...
  801c16:	6a 28                	push   $0x28
  801c18:	e8 43 fb ff ff       	call   801760 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801c41:	6a 27                	push   $0x27
  801c43:	e8 18 fb ff ff       	call   801760 <syscall>
...
void chktst(uint32 n)
{
  ...
  801c5c:	6a 29                	push   $0x29
  801c5e:	e8 fd fa ff ff       	call   801760 <syscall>
...
void inctst()
{
  ...
  801c76:	6a 2a                	push   $0x2a
  801c78:	e8 e3 fa ff ff       	call   801760 <syscall>
...
uint32 gettst()
{
  ...
  801c90:	6a 2b                	push   $0x2b
  801c92:	e8 c9 fa ff ff       	call   801760 <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801cae:	e8 ad fa ff ff       	call   801760 <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801cdf:	e8 7c fa ff ff       	call   801760 <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801d10:	e8 4b fa ff ff       	call   801760 <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801d41:	e8 1a fa ff ff       	call   801760 <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801d6e:	6a 2d                	push   $0x2d
  801d70:	e8 eb f9 ff ff       	call   801760 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801d8f:	52                   	push   %edx
  801d90:	50                   	push   %eax
  801d91:	6a 2e                	push   $0x2e
  801d93:	e8 c8 f9 ff ff       	call   801760 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801daf:	52                   	push   %edx
  801db0:	50                   	push   %eax
  801db1:	6a 2f                	push   $0x2f
  801db3:	e8 a8 f9 ff ff       	call   801760 <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801ddf:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  801df5:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801df8:	83 ec 0c             	sub    $0xc,%esp
  801dfb:	50                   	push   %eax
  801dfc:	e8 76 fd ff ff       	call   801b77 <sys_get_virtual_time>
  801e01:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801e04:	eb 41                	jmp    801e47 <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801e06:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801e09:	83 ec 0c             	sub    $0xc,%esp
  801e0c:	50                   	push   %eax
  801e0d:	e8 65 fd ff ff       	call   801b77 <sys_get_virtual_time>
  801e12:	83 c4 0c             	add    $0xc,%esp
  ...
  801e22:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801e25:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801e28:	89 d1                	mov    %edx,%ecx
  801e2a:	29 c1                	sub    %eax,%ecx
  801e2c:	8b 55 d8             	mov    -0x28(%ebp),%edx
  801e2f:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801e32:	39 c2                	cmp    %eax,%edx
  801e34:	0f 97 c0             	seta   %al
  ...
  801e41:	8b 45 d8             	mov    -0x28(%ebp),%eax
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801e4a:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  801e4d:	72 b7                	jb     801e06 <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801e55:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  801e58:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  801e5f:	eb 03                	jmp    801e64 <busy_wait+0x12>
  801e61:	ff 45 fc             	incl   -0x4(%ebp)
  801e64:	8b 45 fc             	mov    -0x4(%ebp),%eax
  801e67:	3b 45 08             	cmp    0x8(%ebp),%eax
  801e6a:	72 f5                	jb     801e61 <busy_wait+0xf>
	return i;
...
00801e74 <__udivdi3>:
  ...
  801e87:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801e8b:	89 ca                	mov    %ecx,%edx
  801e8d:	89 f8                	mov    %edi,%eax
  801e8f:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  801e93:	85 f6                	test   %esi,%esi
  801e95:	75 2d                	jne    801ec4 <__udivdi3+0x50>
  801e97:	39 cf                	cmp    %ecx,%edi
  801e99:	77 65                	ja     801f00 <__udivdi3+0x8c>
  801e9b:	89 fd                	mov    %edi,%ebp
  801e9d:	85 ff                	test   %edi,%edi
  801e9f:	75 0b                	jne    801eac <__udivdi3+0x38>
  ...
  801ec6:	77 28                	ja     801ef0 <__udivdi3+0x7c>
  801ec8:	0f bd fe             	bsr    %esi,%edi
  801ecb:	83 f7 1f             	xor    $0x1f,%edi
  801ece:	75 40                	jne    801f10 <__udivdi3+0x9c>
  801ed0:	39 ce                	cmp    %ecx,%esi
  801ed2:	72 0a                	jb     801ede <__udivdi3+0x6a>
  801ed4:	3b 44 24 08          	cmp    0x8(%esp),%eax
  801ed8:	0f 87 9e 00 00 00    	ja     801f7c <__udivdi3+0x108>
  801ede:	b8 01 00 00 00       	mov    $0x1,%eax
  801ee3:	89 fa                	mov    %edi,%edx
  ...
  801ef2:	31 c0                	xor    %eax,%eax
  801ef4:	89 fa                	mov    %edi,%edx
  801ef6:	83 c4 1c             	add    $0x1c,%esp
  801ef9:	5b                   	pop    %ebx
  801efa:	5e                   	pop    %esi
  801efb:	5f                   	pop    %edi
  801efc:	5d                   	pop    %ebp
  ...
  801f0e:	5d                   	pop    %ebp
  801f0f:	c3                   	ret    
  801f10:	bd 20 00 00 00       	mov    $0x20,%ebp
  801f15:	89 eb                	mov    %ebp,%ebx
  801f17:	29 fb                	sub    %edi,%ebx
  801f19:	89 f9                	mov    %edi,%ecx
  801f1b:	d3 e6                	shl    %cl,%esi
  801f1d:	89 c5                	mov    %eax,%ebp
  801f1f:	88 d9                	mov    %bl,%cl
  801f21:	d3 ed                	shr    %cl,%ebp
  801f23:	89 e9                	mov    %ebp,%ecx
  801f25:	09 f1                	or     %esi,%ecx
  801f27:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801f2b:	89 f9                	mov    %edi,%ecx
  801f2d:	d3 e0                	shl    %cl,%eax
  801f2f:	89 c5                	mov    %eax,%ebp
  801f31:	89 d6                	mov    %edx,%esi
  801f33:	88 d9                	mov    %bl,%cl
  801f35:	d3 ee                	shr    %cl,%esi
  801f37:	89 f9                	mov    %edi,%ecx
  801f39:	d3 e2                	shl    %cl,%edx
  801f3b:	8b 44 24 08          	mov    0x8(%esp),%eax
  801f3f:	88 d9                	mov    %bl,%cl
  801f41:	d3 e8                	shr    %cl,%eax
  801f43:	09 c2                	or     %eax,%edx
  801f45:	89 d0                	mov    %edx,%eax
  801f47:	89 f2                	mov    %esi,%edx
  801f49:	f7 74 24 0c          	divl   0xc(%esp)
  801f4d:	89 d6                	mov    %edx,%esi
  801f4f:	89 c3                	mov    %eax,%ebx
  801f51:	f7 e5                	mul    %ebp
  801f53:	39 d6                	cmp    %edx,%esi
  801f55:	72 19                	jb     801f70 <__udivdi3+0xfc>
  801f57:	74 0b                	je     801f64 <__udivdi3+0xf0>
  801f59:	89 d8                	mov    %ebx,%eax
  801f5b:	31 ff                	xor    %edi,%edi
  801f5d:	e9 58 ff ff ff       	jmp    801eba <__udivdi3+0x46>
  801f62:	66 90                	xchg   %ax,%ax
  801f64:	8b 54 24 08          	mov    0x8(%esp),%edx
  801f68:	89 f9                	mov    %edi,%ecx
  801f6a:	d3 e2                	shl    %cl,%edx
  801f6c:	39 c2                	cmp    %eax,%edx
  801f6e:	73 e9                	jae    801f59 <__udivdi3+0xe5>
  801f70:	8d 43 ff             	lea    -0x1(%ebx),%eax
  801f73:	31 ff                	xor    %edi,%edi
  801f75:	e9 40 ff ff ff       	jmp    801eba <__udivdi3+0x46>
  801f7a:	66 90                	xchg   %ax,%ax
  801f7c:	31 c0                	xor    %eax,%eax
  801f7e:	e9 37 ff ff ff       	jmp    801eba <__udivdi3+0x46>
  801f83:	90                   	nop
...
00801f84 <__umoddi3>:
  ...
  801f97:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  801f9b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801f9f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801fa3:	89 f3                	mov    %esi,%ebx
  801fa5:	89 fa                	mov    %edi,%edx
  801fa7:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801fab:	89 34 24             	mov    %esi,(%esp)
  801fae:	85 c0                	test   %eax,%eax
  801fb0:	75 1a                	jne    801fcc <__umoddi3+0x48>
  801fb2:	39 f7                	cmp    %esi,%edi
  801fb4:	0f 86 a2 00 00 00    	jbe    80205c <__umoddi3+0xd8>
  ...
  801fce:	0f 87 ac 00 00 00    	ja     802080 <__umoddi3+0xfc>
  801fd4:	0f bd e8             	bsr    %eax,%ebp
  801fd7:	83 f5 1f             	xor    $0x1f,%ebp
  801fda:	0f 84 ac 00 00 00    	je     80208c <__umoddi3+0x108>
  801fe0:	bf 20 00 00 00       	mov    $0x20,%edi
  801fe5:	29 ef                	sub    %ebp,%edi
  801fe7:	89 fe                	mov    %edi,%esi
  801fe9:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801fed:	89 e9                	mov    %ebp,%ecx
  801fef:	d3 e0                	shl    %cl,%eax
  801ff1:	89 d7                	mov    %edx,%edi
  801ff3:	89 f1                	mov    %esi,%ecx
  801ff5:	d3 ef                	shr    %cl,%edi
  801ff7:	09 c7                	or     %eax,%edi
  801ff9:	89 e9                	mov    %ebp,%ecx
  801ffb:	d3 e2                	shl    %cl,%edx
  801ffd:	89 14 24             	mov    %edx,(%esp)
  802000:	89 d8                	mov    %ebx,%eax
  802002:	d3 e0                	shl    %cl,%eax
  802004:	89 c2                	mov    %eax,%edx
  802006:	8b 44 24 08          	mov    0x8(%esp),%eax
  80200a:	d3 e0                	shl    %cl,%eax
  80200c:	89 44 24 04          	mov    %eax,0x4(%esp)
  802010:	8b 44 24 08          	mov    0x8(%esp),%eax
  802014:	89 f1                	mov    %esi,%ecx
  802016:	d3 e8                	shr    %cl,%eax
  802018:	09 d0                	or     %edx,%eax
  80201a:	d3 eb                	shr    %cl,%ebx
  80201c:	89 da                	mov    %ebx,%edx
  80201e:	f7 f7                	div    %edi
  802020:	89 d3                	mov    %edx,%ebx
  802022:	f7 24 24             	mull   (%esp)
  802025:	89 c6                	mov    %eax,%esi
  802027:	89 d1                	mov    %edx,%ecx
  802029:	39 d3                	cmp    %edx,%ebx
  80202b:	0f 82 87 00 00 00    	jb     8020b8 <__umoddi3+0x134>
  802031:	0f 84 91 00 00 00    	je     8020c8 <__umoddi3+0x144>
  802037:	8b 54 24 04          	mov    0x4(%esp),%edx
  80203b:	29 f2                	sub    %esi,%edx
  80203d:	19 cb                	sbb    %ecx,%ebx
  80203f:	89 d8                	mov    %ebx,%eax
  802041:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802045:	d3 e0                	shl    %cl,%eax
  802047:	89 e9                	mov    %ebp,%ecx
  802049:	d3 ea                	shr    %cl,%edx
  80204b:	09 d0                	or     %edx,%eax
  80204d:	89 e9                	mov    %ebp,%ecx
  80204f:	d3 eb                	shr    %cl,%ebx
  802051:	89 da                	mov    %ebx,%edx
  802053:	83 c4 1c             	add    $0x1c,%esp
  802056:	5b                   	pop    %ebx
  802057:	5e                   	pop    %esi
  802058:	5f                   	pop    %edi
  802059:	5d                   	pop    %ebp
  80205a:	c3                   	ret    
  80205b:	90                   	nop
  80205c:	89 fd                	mov    %edi,%ebp
  80205e:	85 ff                	test   %edi,%edi
  802060:	75 0b                	jne    80206d <__umoddi3+0xe9>
  ...
  802073:	89 c8                	mov    %ecx,%eax
  802075:	f7 f5                	div    %ebp
  802077:	89 d0                	mov    %edx,%eax
  802079:	e9 44 ff ff ff       	jmp    801fc2 <__umoddi3+0x3e>
  ...
  80208a:	5d                   	pop    %ebp
  80208b:	c3                   	ret    
  80208c:	3b 04 24             	cmp    (%esp),%eax
  80208f:	72 06                	jb     802097 <__umoddi3+0x113>
  802091:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  802095:	77 0f                	ja     8020a6 <__umoddi3+0x122>
  802097:	89 f2                	mov    %esi,%edx
  802099:	29 f9                	sub    %edi,%ecx
  80209b:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  80209f:	89 14 24             	mov    %edx,(%esp)
  8020a2:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  8020a6:	8b 44 24 04          	mov    0x4(%esp),%eax
  8020aa:	8b 14 24             	mov    (%esp),%edx
  ...
  8020b8:	2b 04 24             	sub    (%esp),%eax
  8020bb:	19 fa                	sbb    %edi,%edx
  8020bd:	89 d1                	mov    %edx,%ecx
  8020bf:	89 c6                	mov    %eax,%esi
  8020c1:	e9 71 ff ff ff       	jmp    802037 <__umoddi3+0xb3>
  8020c6:	66 90                	xchg   %ax,%ax
  8020c8:	39 44 24 04          	cmp    %eax,0x4(%esp)
  8020cc:	72 ea                	jb     8020b8 <__umoddi3+0x134>
  8020ce:	89 d9                	mov    %ebx,%ecx
  8020d0:	e9 62 ff ff ff       	jmp    802037 <__umoddi3+0xb3>
